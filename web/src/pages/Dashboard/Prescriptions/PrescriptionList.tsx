    ...
    <div className="animate-fade-in">
      <header style={{ marginBottom: '2rem', display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '1rem' }}>
        <div style={{ flex: '1 1 250px' }}>
          <h1 style={{ fontSize: '1.5rem', fontWeight: 800 }}>All Prescriptions</h1>
          <p style={{ color: 'var(--muted)', fontSize: '0.9rem' }}>Managing active medications across your pharmacy.</p>
        </div>
        <div className="input-group" style={{ marginBottom: 0, width: '100%', maxWidth: '350px', position: 'relative', flex: '1 1 300px' }}>
